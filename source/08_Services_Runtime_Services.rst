...
.. note:: **DEPRECATED: Private Authenticated Variables** - The use of the EFI_VARIABLE_TIME_BASED_AUTHENTICATED_WRITE_ACCESS attribute for variables other than Secure Boot Policy Variables (see :ref:`secure-boot-policy-variables`) is deprecated and should no longer be used. This feature will be removed from future versions of the specification.
