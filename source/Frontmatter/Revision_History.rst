...
.. csv-table::
   ...
   **Revision** | **Issue # - Description** | **Modified/Added Content**
   2.12 | 2568 - Define Secure Boot Policy Variables | :numref:`globally-defined-variables`
   2.12 | 2568 - Deprecate Private Authenticated Variables | :numref:`setvariable`, :numref:`using-the-efi-variable-authentication-2-descriptor`, :numref:`signature-database-update`
